...
var author$project$Main$Call = {$: 'Call'};
var author$project$Main$Option = F3(
	function (type_, strike, premium) {
		return {premium: premium, strike: strike, type_: type_};
	});
var author$project$Main$OptionTrade = F3(
	function (a, b, c) {
		return {$: 'OptionTrade', a: a, b: b, c: c};
	});
...
var author$project$Main$init = {
	...
	strike: '',
	tradeType: 'buy',
	trades: _List_fromArray(
		[
			{
			active: true,
			id: 0,
			trade: A3(
				author$project$Main$OptionTrade,
				A3(author$project$Main$Option, author$project$Main$Call, 10600, 158.9),
			...
			trade: A3(
				author$project$Main$OptionTrade,
				A3(author$project$Main$Option, author$project$Main$Call, 10800, 52.5),
				author$project$Main$Sell,
				75)
		}
		])
};
var author$project$Main$TradeHtml = F3(
	function (trade, active, id) {
		return {active: active, id: id, trade: trade};
	});
var elm$core$Basics$append = _Utils_append;
var elm$core$Maybe$Just = function (a) {
	return {$: 'Just', a: a};
};
var author$project$Main$putWrongInputError = F2(
	function (model, s) {
		return _Utils_update(
			model,
			{
				errMsg: elm$core$Maybe$Just('Wrong input ' + s)
			});
	});
var author$project$Main$Put = {$: 'Put'};
var author$project$Main$stringToOptionType = function (s) {
	switch (s) {
		case 'call':
			return elm$core$Maybe$Just(author$project$Main$Call);
		case 'put':
			return elm$core$Maybe$Just(author$project$Main$Put);
		default:
			return elm$core$Maybe$Nothing;
	}
};
var author$project$Main$stringToTradeType = function (s) {
	switch (s) {
		case 'buy':
			return elm$core$Maybe$Just(author$project$Main$Buy);
		case 'sell':
			return elm$core$Maybe$Just(author$project$Main$Sell);
		default:
			return elm$core$Maybe$Nothing;
	}
};
...
var author$project$Main$addTrade = function (model) {
	var _n0 = elm$core$String$toFloat(model.strike);
	if (_n0.$ === 'Just') {
		var s = _n0.a;
		var _n1 = elm$core$String$toFloat(model.price);
		if (_n1.$ === 'Just') {
			var p = _n1.a;
			var _n2 = elm$core$String$toInt(model.quantity);
			if (_n2.$ === 'Just') {
				var q = _n2.a;
				var _n3 = author$project$Main$stringToOptionType(model.optionType);
				if (_n3.$ === 'Just') {
					var ot = _n3.a;
					var _n4 = author$project$Main$stringToTradeType(model.tradeType);
					if (_n4.$ === 'Just') {
						var tt = _n4.a;
						return _Utils_update(
							model,
							{
								...
								trades: _Utils_ap(
									...
									_List_fromArray(
										[
											A3(
											author$project$Main$TradeHtml,
											A3(
												author$project$Main$OptionTrade,
												A3(author$project$Main$Option, ot, s, p),
												tt,
												q),
											true,
											model.id)
						...
						return A2(author$project$Main$putWrongInputError, model, 'Buy or Sell');
					}
				} else {
					return A2(author$project$Main$putWrongInputError, model, 'option type');
				}
			} else {
				return A2(author$project$Main$putWrongInputError, model, 'quantity');
			}
		} else {
			return A2(author$project$Main$putWrongInputError, model, 'price');
		}
	} else {
		return A2(author$project$Main$putWrongInputError, model, 'strike price');
	}
};
var elm$core$Basics$eq = _Utils_equal;
var author$project$Main$checkIdMatch = F2(
	function (id, t) {
		return _Utils_eq(t.id, id);
	});
var elm$core$Basics$not = _Basics_not;
var author$project$Main$flipActive = F2(
	function (id, t) {
		...
		switch (msg.$) {
			...
			case 'OptionType':
				...
				return _Utils_update(
					...
					{optionType: ot});
			case 'AddTrade':
				return author$project$Main$addTrade(model);
			case 'DeleteTrade':
				var id = msg.a;
				return _Utils_update(
					model,
					{
						trades: A2(
							...
							A2(
								...
								elm$core$Basics$not,
								author$project$Main$checkIdMatch(id)),
							model.trades)
					});
			default:
				var id = msg.a;
				return _Utils_update(
					model,
					{
						trades: A2(
							elm$core$List$map,
							author$project$Main$flipActive(id),
							model.trades)
					});
		}
	});
var author$project$Main$DeleteTrade = function (a) {
	return {$: 'DeleteTrade', a: a};
};
var author$project$Main$FlipActive = function (a) {
	return {$: 'FlipActive', a: a};
};
var author$project$Main$getTradeOption = function (_n0) {
	var o = _n0.a;
	return o;
};
var author$project$Main$getTradeQuantity = function (_n0) {
	var q = _n0.c;
	return q;
};
var author$project$Main$getTradeType = function (_n0) {
	var tt = _n0.b;
	return tt;
};
...
var author$project$Main$convTradeHtml = function (th) {
	...
	return A2(
		...
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('row mb-1')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						A3(
							...
							_List_fromArray(
								[
									A2(elm$core$Basics$composeL, elm$core$Debug$toString, author$project$Main$getTradeType)(th.trade),
									' ',
									A2(elm$core$Basics$composeL, elm$core$Debug$toString, author$project$Main$getTradeQuantity)(th.trade),
									' ',
									A2(
									elm$core$Basics$composeL,
									A2(
									...
									author$project$Main$getTradeOption)(th.trade),
					...
					[
						...
						_List_fromArray(
							[
								...
								th.active ? 'Hide' : 'Unhide'),
								elm$html$Html$Events$onClick(
								author$project$Main$FlipActive(th.id))
							]),
						_List_Nil),
						A2(
						elm$html$Html$input,
						_List_fromArray(
							[
								...
								elm$html$Html$Attributes$type_('submit'),
								elm$html$Html$Attributes$value('Remove'),
								elm$html$Html$Events$onClick(
								author$project$Main$DeleteTrade(th.id))
							]),
						_List_Nil)
					]))
			]));
};
var author$project$Main$getActiveTrades = A2(
	elm$core$Basics$composeL,
	A2(
		elm$core$Basics$composeL,
		elm$core$List$map(
...
var author$project$Main$AddTrade = {$: 'AddTrade'};
var author$project$Main$OptionType = function (a) {
	return {$: 'OptionType', a: a};
};
var author$project$Main$Price = function (a) {
	return {$: 'Price', a: a};
};
var author$project$Main$Quantity = function (a) {
	return {$: 'Quantity', a: a};
};
var author$project$Main$Strike = function (a) {
	return {$: 'Strike', a: a};
};
var author$project$Main$TradeType = function (a) {
	return {$: 'TradeType', a: a};
};
var author$project$Main$buySelectOption = {text_: 'Buy', value: 'buy'};
var author$project$Main$callSelectOption = {text_: 'Call', value: 'call'};
var author$project$Main$getErrorText = function (model) {
	var _n0 = model.errMsg;
	if (_n0.$ === 'Just') {
		var err = _n0.a;
...
var author$project$Main$getOptionView = function (so) {
	return A2(
		elm$html$Html$option,
		_List_fromArray(
			[
				elm$html$Html$Attributes$value(so.value)
			]),
		_List_fromArray(
			[
				elm$html$Html$text(so.text_)
			]));
};
...
var author$project$Main$getSelect = F2(
	function (lo, toMsg) {
		return A2(
			elm$html$Html$div,
			_List_fromArray(
			...
			_List_fromArray(
				[
					...
					elm$core$List$map(author$project$Main$getOptionView))(lo)
				]));
	});
var author$project$Main$putSelectOption = {text_: 'Put', value: 'put'};
var author$project$Main$sellSelectOption = {text_: 'Sell', value: 'sell'};
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2(
						author$project$Main$getSelect,
						_List_fromArray(
							[author$project$Main$buySelectOption, author$project$Main$sellSelectOption]),
						author$project$Main$TradeType),
						A2(
						author$project$Main$getSelect,
						_List_fromArray(
							[author$project$Main$callSelectOption, author$project$Main$putSelectOption]),
						author$project$Main$OptionType)
					])),
				A2(
				elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						A4(author$project$Main$viewInput, 'text', 'Strike', model.strike, author$project$Main$Strike),
						A4(author$project$Main$viewInput, 'text', 'Price', model.price, author$project$Main$Price),
						A4(author$project$Main$viewInput, 'text', 'Quantity', model.quantity, author$project$Main$Quantity)
					])),
				...
				_List_fromArray(
					[
						...
						elm$html$Html$Events$onClick(author$project$Main$AddTrade)
					]),
				_List_Nil),
				author$project$Main$getErrorText(model)
			]));
};
var author$project$Main$Point = F2(
	function (expPrice, profit) {
		return {expPrice: expPrice, profit: profit};
	});
var author$project$Main$addExtraFront = F2(
	function (factor, lx) {
		if (!lx.b) {
			return _List_Nil;
		} else {
...
var author$project$Main$addExtraBack = A2(
	elm$core$Basics$composeL,
	A2(
		elm$core$Basics$composeL,
		elm$core$List$reverse,
		author$project$Main$addExtraFront(1.01)),
	elm$core$List$reverse);
var author$project$Main$getStrikePrice = function (_n0) {
	var o = _n0.a;
	var tt = _n0.b;
	var q = _n0.c;
	return o.strike;
...
var author$project$Main$computeXPoints = A2(
	elm$core$Basics$composeL,
	A2(
		elm$core$Basics$composeL,
		A2(
			elm$core$Basics$composeL,
			author$project$Main$addExtraBack,
			author$project$Main$addExtraFront(0.99)),
		elm$core$List$sort),
	elm$core$List$map(author$project$Main$getStrikePrice));
var elm$core$Basics$negate = function (n) {
	return -n;
};
var author$project$Main$getPnL = F2(
	function (_n0, expPrice) {
		var o = _n0.a;
		var tt = _n0.b;
		var q = _n0.c;
		var profitPerStock = function () {
			var _n2 = o.type_;
			if (_n2.$ === 'Call') {
				return (_Utils_cmp(expPrice, o.strike) < 0) ? (-o.premium) : ((expPrice - o.strike) - o.premium);
			} else {
				return (_Utils_cmp(expPrice, o.strike) > 0) ? (-o.premium) : ((o.strike - expPrice) - o.premium);
			}
		}();
		var profit = profitPerStock * q;
		if (tt.$ === 'Buy') {
			return profit;
		} else {
			return -profit;
...
var author$project$Main$getMultiPnL = F2(
	function (lt, expPrice) {
		return A3(
			elm$core$List$foldl,
			function (t) {
				return function (v) {
					return A2(author$project$Main$getPnL, t, expPrice) + v;
				};
			},
			0,
			lt);
	});
var author$project$Main$getPoints = function (lt) {
	return A2(
		elm$core$Basics$composeL,
		elm$core$List$map(
			function (x) {
				return A2(
					...
					x,
					A2(author$project$Main$getMultiPnL, lt, x));
			}),
		author$project$Main$computeXPoints)(lt);
};
...
var author$project$Main$getPnLChart = function (lt) {
	return A2(
		...
		_List_fromArray(
			[
				...
				terezka$line_charts$LineChart$Colors$green,
				terezka$line_charts$LineChart$Dots$circle,
				'Strategy',
				author$project$Main$getPoints(lt))
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text('Stock Options Strategy Builder')
					])),
				A2(elm$core$Basics$composeL, author$project$Main$getPnLChart, author$project$Main$getActiveTrades)(model),
				A2(
				elm$html$Html$div,
				_List_fromArray(
					[
				...
				A2(
					elm$core$Basics$composeL,
					elm$core$List$map(author$project$Main$convTradeHtml),
					function ($) {
						return $.trades;
					})(model)),
				A2(elm$html$Html$br, _List_Nil, _List_Nil),
